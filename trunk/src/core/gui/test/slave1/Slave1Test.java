...
public class Slave1Test extends JFrame {
	...
	private JButton creaBotonDeMeterEje() {
		...
		jButton.addActionListener(new AlimentaActionListener(slave1,Slave1Input.FEED_AXIS));
		return jButton;
	}

	private JButton creaBotonDeMeterEngranaje() {
		JButton jButton = new JButton("Mete Engranaje");
		jButton.addActionListener(new AlimentaActionListener(slave1,Slave1Input.FEED_GEAR));
		return jButton;
	}
